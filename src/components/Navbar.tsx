...
export default function Navbar() {
  return (
    <motion.nav
      ...
      className="fixed top-0 left-0 w-full z-[100] px-6 py-4 glass"
    >
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        <div className="flex items-center gap-2">
          <span className="font-display text-2xl font-black tracking-tighter text-white">
            SUSHI<span className="text-mexico">NACHOS</span>
          </span>
        </div>
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          className="px-6 py-2 bg-gradient-to-r from-mexico to-tequila text-black font-bold rounded-full shadow-[0_0_20px_rgba(255,0,85,0.4)] interactive transition-transform uppercase text-xs"
        >
          PEDIR AGORA
        </motion.a>
      </div>
